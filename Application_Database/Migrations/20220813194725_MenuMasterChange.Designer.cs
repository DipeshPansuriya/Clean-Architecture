...
namespace Application_Database.Migrations
{
    ...
    [Migration("20220813194725_MenuMasterChange")]
    partial class MenuMasterChange
    {
            ...
            modelBuilder.Entity("Application_Database.AdminRights", b =>
                {
                    ...
                    b.HasIndex(new[] { "MenuId" }, "IX_AdminRights_MenuId");

                    b.HasIndex(new[] { "RoleId" }, "IX_AdminRights_RoleId");
